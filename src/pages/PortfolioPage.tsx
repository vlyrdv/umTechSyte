        ...
        <div className="container page-hero__inner">
          <Reveal>
            ...
            <p>
              ...
              данных, моделях для создания новых вариантов и ML-системах для бизнеса. Мы создаём решения
              не ради “AI”, а под конкретную задачу: найти объект на фото, предсказать спрос,
              быстро найти ответ в документах, разобрать текст или убрать ручную работу.
            </p>
          </Reveal>
        </div>
      </section>
